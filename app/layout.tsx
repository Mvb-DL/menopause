  ...
  return (
    <html lang="en">
      <body>
        ...
        {/* Links section */}
        <div className="links">
          <a href="https://dev.to/uuuuuulala/making-background-blob-animation-in-just-15kb-step-by-step-guide-2482" target="_blank">
            tutorial
            <img className="icon" src="https://ksenia-k.com/img/icons/link.svg" alt="Link Icon" />
          </a>
        </div>
